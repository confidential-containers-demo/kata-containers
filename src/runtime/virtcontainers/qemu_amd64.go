...
const (
	...
	// The client-side guest owner proxy is a temporary component of the
	// confidential containers CCv0 demo. Eventually, gRPC calls to the
	// guest owner attestation service will originate from within the kata shim,
	// avoiding this external script .
	//
